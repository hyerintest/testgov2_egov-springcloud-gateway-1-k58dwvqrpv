...
public class WebFluxSecurityConfig {
    ...
    public SecurityWebFilterChain configure(ServerHttpSecurity http, ReactiveAuthorizationManager<AuthorizationContext> check) throws Exception {
        String[] modifiedPermitAllAntPatterns = Arrays.copyOf(PERMITALL_ANTPATTERNS, PERMITALL_ANTPATTERNS.length + 1);
        modifiedPermitAllAntPatterns[PERMITALL_ANTPATTERNS.length] = servicePath+"/**";
        ...
        http
            ...
            .and()
                .authorizeExchange()
                .pathMatchers(modifiedPermitAllAntPatterns).permitAll()
